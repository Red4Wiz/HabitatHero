...
Objective:
The objective of the game is to always have a shelter at night and if you don’t then the game ends. Each night the shelter takes a random amount of damage that you have to fix the next day. The materials are also spawned at random so be careful with your selection.
